...
import { BoxTextField, Button, BackButton } from "../../components";
...
const ForgotPinOtp = () => {
  ...
  function renderTop() {
    return <BackButton text="Forgot PIN" />;
  }

  function renderContent() {
    return (
      <View>
        <Text style={styles.contentTitle}>OTP Verification</Text>
        <View>
          <BoxTextField
            pin={pin}
            setPin={setPin}
  ...
  return (
    ...
    >
      ...
      <View style={styles.buttonContainer}>
        <Button text="Continue" onPress={handleLogIn} width={"100%"} />
      </View>
    </SafeAreaView>
  );
};
